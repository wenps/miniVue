...
function setupComponent(instance) {
    ...
    initSlot(instance, instance.vnode.children); // 初始化组件实例的slot，对于组件虚拟节点而言children是传入的slot中的内容，因此将vnode.children中的内容提前到组件实例对象instance的props中
...
export { computed, createApp, createAppApi, createTextVNode, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, provide, proxyRefs, reactive, readonly, ref, renderSlot, shallowReadonly, unRef };
